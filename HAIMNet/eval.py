...
eval_parser.add_argument('--unpaired_weights', type=str, default='/dataC/iedA/wzq/HAIMNet/train_record/final_best_trans/unpaired/VV/vv.pth')
...
if __name__ == '__main__':
    ...
    alpha = None
    if ep.lol:
        eval_data = DataLoader(dataset=get_eval_set("./datasets/LOLv1/Test/input"), num_workers=num_workers,
                               batch_size=1, shuffle=False)
        output_folder = './output/LOLv1/'
        weight_path = '/dataC/iedA/wzq/HAIMNet/train_record/final_best_trans/lolv1/lolv1.pth'
        ...
        weight_path = '/dataC/iedA/wzq/HAIMNet/weights/lolv2real.pth'
        alpha = 0.84
        ...
        weight_path = '/dataC/iedA/wzq/HAIMNet/train_record/final_best_trans/lolv2syn/lolv2syn.pth'
        ...
        weight_path = '/dataC/iedA/wzq/HAIMNet/train_record/final_best_trans/SICE_grad/sice_grad.pth'
        norm_size = False
        ...
        weight_path = '/dataC/iedA/wzq/HAIMNet/train_record/final_best_trans/SICE_mix/sice_mix.pth'
        norm_size = False
