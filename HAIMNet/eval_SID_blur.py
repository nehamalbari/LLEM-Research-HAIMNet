...
if __name__ == '__main__':
    ...
    if ep.Blur:
        for index in range(1,257):
            ...
            model_path = "/dataC/iedA/wzq/HAIMNet/train_record/final_best_trans/Blur/DarkIR.pth"
        ...
        for index in range(1,230):
            ...
            now_dir = test_dir + fill_index + "/"
            model_path = "/dataC/iedA/wzq/HAIMNet/train_record/final_best_trans/SID/sid.pth"
